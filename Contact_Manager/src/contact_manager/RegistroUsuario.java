...
public class RegistroUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTFalumno.setActionCommand("<Not Set>");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTFalumno, javax.swing.GroupLayout.DEFAULT_SIZE, 351, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{ 
          Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/isunah_prog2","root","Izzy.2128");        
            PreparedStatement pst = con2.prepareStatement("INSERT INTO usuario(alumno, nombre, password)" 
                + "VALUES (?,?,?)");
            pst.setString(1,jTFalumno.getText());
            pst.setString(2,jTFname.getText());
            pst.setString(3,jTFpass.getText());
            pst.executeUpdate();
