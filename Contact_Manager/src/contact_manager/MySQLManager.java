 ...
 * @author Lizzy
 */
public class MySQLManager extends javax.swing.JFrame {
    /**
    ...
    private void initComponents() {
        ...
        jTFname.setBackground(new java.awt.Color(255, 204, 102));
        jTFname.setActionCommand("<Not Set>");
        ...
        jTFpass.setBackground(new java.awt.Color(255, 204, 102));
        ...
        jTFalumno.setBackground(new java.awt.Color(255, 204, 102));
        ...
        jLabel5.setText("Agenda Estudiantil");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTFname, javax.swing.GroupLayout.DEFAULT_SIZE, 325, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{ 
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/isunah_prog2","root","Izzy.2128");
          Statement st=con.createStatement();
          ResultSet rs=st.executeQuery("SELECT*FROM usuario WHERE  nombre='"+jTFname.getText()+ "' AND password= '"+ jTFpass.getText() + "'");
         
          if( rs.next()){
           AgendaEstudiante contacto = new AgendaEstudiante();
           contacto.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MySQLManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MySQLManager().setVisible(true);
            }
        });
    }
